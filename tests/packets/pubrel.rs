use core::ops::Deref;
use mqtt_tiny::{packets::TryFromIterator, Pubrel};
...
impl Good {
    ...
    pub const fn all() -> [Self; 1] {
        [
            // The PUBREL packet does not have any context specific encoding
            Self { encoded: b"\x60\x02\x04\x07", decoded: Pubrel::new(0x0407) },
        ]
    }
}
